...
namespace ParkingLot.Controllers
{
    ...
    {
        private readonly ISecurityBusiness _userBusiness;
        ...
        public SecurityController(ISecurityBusiness userBusiness, IConfiguration configuration)
        {
        ...
        private string GenerateToken(RegistrationResponse userDetails, string tokenType)
        {
            try
            {
                ...
                var claims = new[]
                {
                    new Claim("SecurityID", userDetails.ID.ToString()),
